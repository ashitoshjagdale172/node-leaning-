...
//       res.status(200).json(response);
//     } else {
//       res.status(404).send({ err: "invalid work error" });
//     }
//   } catch (err) {
//     console.log(err);
...
//     let personID = req.params.id;
//     let updatePersonData = req.body;
//     let response = await personID.findIdAndUpdate(personId, updatePersonData, {
//       new: true, //  return Updated document
//       runValidators: true, // run mongodb validation (that is in schema)
//     });
//     if (!response) {
//       res.status(404).json({ err: " person not found" });
//     }
